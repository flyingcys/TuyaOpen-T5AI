...
#define LV_USE_LFS 1
#if LV_USE_LFS
    #define LV_FS_LFS_LETTER '/'      /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_LFS_CACHE_SIZE 0    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif

/*API for LittleFs. */
#define LV_USE_TUYA_FS 1
#if LV_USE_TUYA_FS
    #define LV_TUYA_FS_LETTER '/'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
#endif
